...
const Tos = () => {
  ...
  return (
    <>
      <Head>
        <title>Easyviews | Terms of Service</title>
        <meta
          name="description"
          content="See the terms and conditions on using our service."
        ></meta>
        <meta property="og:title" content="Easyviews | Terms of Service" />
